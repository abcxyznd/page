...
import pixelAvatar from "../assets/avatar.png";
  ...
  return (
    <section className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <AnimatedSection animation="slide-in-up" className="w-full relative z-10">
        <TerminalWindow title="root@tuiduc:~#" className="w-full max-w-4xl mx-auto backdrop-blur-md bg-background/95 border border-primary/20 shadow-2xl">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Link to="/friends">
                  ...
                  >
                    ...
                    <span className="relative z-10">Cộng Tác Viên</span>
                  </Button>
                </Link>
                <Link to="/converter">
                  <Button 

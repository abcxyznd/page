                ...
                <div className="text-center pt-8">
                  <div className="bg-terminal-window/30 backdrop-blur-sm p-6 rounded-xl border border-accent/20">
                    ...
                    <div className="flex justify-center space-x-4 text-xs font-mono">
                      <span className="text-accent">Kinh Nghiệm: 6 Năm +</span>
                      <span className="text-muted-foreground">•</span>
                      <span className="text-accent">Đã Hoàn Thành: 130+ Dự Án</span>
                      <span className="text-muted-foreground">•</span>
                      <span className="text-accent">Vinh Dự Là Đối Tác: 4+ Công Ty & Thương Hiệu</span>
                    </div>
                  </div>
                </div>
              </AnimatedSection>
